...
\begin{itemize}
  \item \textbf{URL d'accès~:} \url{http://192.168.1.253:9090/login}
...
\begin{itemize}
  ...
  \item \textbf{Mot de passe~:} \emph{voir la fiche de transmission des codes d'accès (communiquée via un canal sécurisé séparé).}
\end{itemize}
...
\begin{itemize}
  ...
  \item La Fiche de Transmission des Codes d'Accès (contenant~: mot de passe serveur, accès Drive Cloud, clé de déchiffrement des sauvegardes), communiquée via un canal sécurisé séparé.
\end{itemize}
