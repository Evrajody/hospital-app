    ...
    <div class="client-create-container">
      <div class="page-header">
        <div>
          ...
          <p class="subtitle">Enregistrement d'un nouveau client</p>
        </div>
      </div>
      ...
      <el-card shadow="never">
        ...
        >
          ...
          <div class="form-actions">
            ...
            <el-button v-if="can('clients.creer')" type="primary" :loading="loading" @click="handleSubmit">
...
const breadcrumbs = [
  ...
  { title: 'Nouveau Client', path: '/clients/create' }
];
